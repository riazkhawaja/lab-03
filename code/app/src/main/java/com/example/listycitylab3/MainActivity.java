...
public class MainActivity extends AppCompatActivity implements
    ...
    public void editCity(Integer position, City city) {
        cityAdapter.getItem(position).setName(city.getName());
        cityAdapter.getItem(position).setProvince(city.getProvince());
        cityAdapter.notifyDataSetChanged();
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cityList.setOnItemClickListener((parent, view, position, id) -> {
            ...
            new EditCityFragment(position, selectedCity).show(getSupportFragmentManager(), "Edit City");
        });
